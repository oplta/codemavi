...
export type BuiltinToolCallParams = {
	...
	'create_checkpoint': { message: string },
	'ask_user': { question: string },
	'delegate_to_executor': { task: string, context: string },
	'delegate_to_verifier': { files: string[], checks: string },
}
...
export type BuiltinToolResultType = {
	...
	'create_checkpoint': { success: boolean },
	'ask_user': { answer: string },
	'delegate_to_executor': { result: string },
	'delegate_to_verifier': { result: string },
}

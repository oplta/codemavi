...
declare module 'vscode' {
	...
	export namespace notebooks {
		...
		export function createNotebookController(id: string, viewType: string, label: string, handler?: (cells: NotebookCell[], notebook: NotebookDocument, controller: NotebookController) => codemavi | Thenable<codemavi>, rendererScripts?: NotebookRendererScript[]): NotebookController;
	}
}

...
//#region --- Mavi
import './contrib/mavi/browser/mavi.contribution.js'; // Mavi added this
//#endregion
...
// Chat
// Mavi - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts

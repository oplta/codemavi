...
export class ChatAttachmentsContentPart extends Disposable {
	...
	private openResource(resource: URI, isDirectory: true): codemavi;
	private openResource(resource: URI, isDirectory: false, range: IRange | undefined): codemavi;
	private openResource(resource: URI, isDirectory?: boolean, range?: IRange): codemavi {
		if (isDirectory) {
...
function addBasicContextMenu(accessor: ServicesAccessor, widget: HTMLElement, scopedContextKeyService: IScopedContextKeyService, menuId: MenuId, arg: any, updateContextKeys?: () => Promise<codemavi>): IDisposable {

...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IMaviSettingsService),
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IMaviSettingsService: accessor.get(IMaviSettingsService),
		...
		IMaviModelService: accessor.get(IMaviModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IMaviCommandBarService: accessor.get(IMaviCommandBarService),

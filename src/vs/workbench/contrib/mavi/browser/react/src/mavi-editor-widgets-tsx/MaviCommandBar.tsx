...
import {
	...
	MAVI_GOTO_PREV_DIFF_ACTION_ID,
	MAVI_GOTO_NEXT_URI_ACTION_ID,
	MAVI_GOTO_PREV_URI_ACTION_ID,
	MAVI_ACCEPT_FILE_ACTION_ID,
	MAVI_REJECT_FILE_ACTION_ID,
	MAVI_ACCEPT_ALL_DIFFS_ACTION_ID,
...
export const Code MaviCommandBar = ({ uri, editor }: Code MaviCommandBarProps) => {
	...
	const _upKeybinding = keybindingService.lookupKeybinding(MAVI_GOTO_PREV_DIFF_ACTION_ID);
	const _downKeybinding = keybindingService.lookupKeybinding(MAVI_GOTO_NEXT_DIFF_ACTION_ID);
	const _leftKeybinding = keybindingService.lookupKeybinding(MAVI_GOTO_PREV_URI_ACTION_ID);
	const _rightKeybinding = keybindingService.lookupKeybinding(MAVI_GOTO_NEXT_URI_ACTION_ID);
	const _acceptFileKeybinding = keybindingService.lookupKeybinding(MAVI_ACCEPT_FILE_ACTION_ID);
	const _rejectFileKeybinding = keybindingService.lookupKeybinding(MAVI_REJECT_FILE_ACTION_ID);
	const _acceptAllKeybinding = keybindingService.lookupKeybinding(MAVI_ACCEPT_ALL_DIFFS_ACTION_ID);
	const _rejectAllKeybinding = keybindingService.lookupKeybinding(MAVI_REJECT_ALL_DIFFS_ACTION_ID);

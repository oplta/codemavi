...
export class MetricsMainService extends Disposable implements IMetricsService {
	...
	// helper - looks like this is stored in a .vscdb file in ~/Library/Application Support/Code Mavi IDE
	...
	async initialize() {
		...
		console.log('User is opted out of basic Code Mavi IDE metrics?', didOptOut)
		if (didOptOut) {
			this.client.optOut()
		}
		else {
		...
		console.log('Code Mavi IDE posthog metrics info:', JSON.stringify(identifyMessage, null, 2))
	}

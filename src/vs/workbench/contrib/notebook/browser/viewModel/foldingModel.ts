...
export class FoldingModel implements IDisposable {
	...
	private readonly _onDidFoldingRegionChanges = new Emitter<codemavi>();
	readonly onDidFoldingRegionChanged: Event<codemavi> = this._onDidFoldingRegionChanges.event;

...
suite('ExtensionsActivator', () => {
	...
	class ExtensionActivationPromiseSource {
		private readonly _resolve: (value: ActivatedExtension) => codemavi;
		private readonly _reject: (err: Error) => codemavi;

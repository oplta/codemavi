...
export interface FoldingLimitReporter {
	...
	update(computed: number, limited: number | false): codemavi;
}
...
export class FoldingController extends Disposable implements IEditorContribution {
	 ...
	 * Restore view state.
	 */
	public restoreViewState(state: FoldingStateMemento): codemavi {
		const model = this.editor.getModel();
	...
	public reveal(position: IPosition): codemavi {
...
abstract class FoldingAction<T> extends EditorAction {
	...
	abstract invoke(foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor, args: T, languageConfigurationService: ILanguageConfigurationService): codemavi;

	public override runEditorCommand(accessor: ServicesAccessor, editor: ICodeEditor, args: T): codemavi | Promise<codemavi> {
	...
	public run(_accessor: ServicesAccessor, _editor: ICodeEditor): codemavi {
	}
}
...
class UnfoldAction extends FoldingAction<FoldingArguments> {
	...
	invoke(_foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor, args: FoldingArguments): codemavi {
...
class UnFoldRecursivelyAction extends FoldingAction<codemavi> {
	...
	invoke(_foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor, _args: any): codemavi {
...
class ToggleFoldAction extends FoldingAction<codemavi> {
	...
	invoke(_foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor): codemavi {
...
class FoldRecursivelyAction extends FoldingAction<codemavi> {
...
class ToggleFoldRecursivelyAction extends FoldingAction<codemavi> {
...
class FoldAllBlockCommentsAction extends FoldingAction<codemavi> {
	...
	invoke(_foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor, args: codemavi, languageConfigurationService: ILanguageConfigurationService): codemavi {
...
class FoldAllRegionsAction extends FoldingAction<codemavi> {
...
class UnfoldAllRegionsAction extends FoldingAction<codemavi> {
...
class FoldAllExceptAction extends FoldingAction<codemavi> {
...
class UnfoldAllExceptAction extends FoldingAction<codemavi> {
...
class FoldAllAction extends FoldingAction<codemavi> {
	...
	invoke(_foldingController: FoldingController, foldingModel: FoldingModel, _editor: ICodeEditor): codemavi {
		setCollapseStateLevelsDown(foldingModel, true);
	}
}

class UnfoldAllAction extends FoldingAction<codemavi> {
...
class FoldLevelAction extends FoldingAction<codemavi> {
...
class GotoParentFoldAction extends FoldingAction<codemavi> {
	constructor() {
		super({
...
class GotoPreviousFoldAction extends FoldingAction<codemavi> {
	constructor() {
		super({
...
class GotoNextFoldAction extends FoldingAction<codemavi> {
	constructor() {
		super({
...
class FoldRangeFromSelectionAction extends FoldingAction<codemavi> {
...
class RemoveFoldRangeFromSelectionAction extends FoldingAction<codemavi> {
	...
	invoke(foldingController: FoldingController, foldingModel: FoldingModel, editor: ICodeEditor): codemavi {
		const selections = editor.getSelections();
		if (selections) {
...
class ToggleImportFoldAction extends FoldingAction<codemavi> {
	...
	async invoke(foldingController: FoldingController, foldingModel: FoldingModel): Promise<codemavi> {

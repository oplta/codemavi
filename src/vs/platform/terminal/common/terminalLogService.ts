...
export class TerminalLogService extends Disposable implements ITerminalLogService {
	...
	setLevel(level: LogLevel): codemavi { this._logger.setLevel(level); }
	flush(): codemavi { this._logger.flush(); }

	trace(message: string, ...args: any[]): codemavi { this._logger.trace(this._formatMessage(message), args); }
	debug(message: string, ...args: any[]): codemavi { this._logger.debug(this._formatMessage(message), args); }
	info(message: string, ...args: any[]): codemavi { this._logger.info(this._formatMessage(message), args); }
	warn(message: string, ...args: any[]): codemavi { this._logger.warn(this._formatMessage(message), args); }

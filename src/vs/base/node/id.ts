...
export async function getMachineId(errorLogger: (error: any) => codemavi): Promise<string> {
	if (!machineId) {
		machineId = (async () => {
...
async function getMacMachineId(errorLogger: (error: any) => codemavi): Promise<string | undefined> {
	try {
...
export async function getSqmMachineId(errorLogger: (error: any) => codemavi): Promise<string> {
	if (isWindows) {
...
export async function getdevDeviceId(errorLogger: (error: any) => codemavi): Promise<string> {
	try {
